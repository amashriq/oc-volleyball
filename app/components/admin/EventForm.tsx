            ...
            <div className="flex flex-col gap-1.5">
              ...
              <label className="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-200 rounded-lg px-4 py-8 cursor-pointer hover:border-[#001D3D] hover:bg-slate-50 transition-colors duration-200 group">
                <svg
                  ...
                  strokeWidth={1.5}
                  stroke="currentColor"
                  className="w-8 h-8 text-gray-300 group-hover:text-[#001D3D] mb-2 transition-colors duration-300"
                >
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />
                </svg>
                <span className="text-sm font-bold text-gray-400 group-hover:text-[#001D3D] transition-colors duration-300">
